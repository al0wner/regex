...
static void *cli_socket_main(void *args)
{
	...
	addr.sin_port = htons(switchd_listen_port);
...
/*--------------------------------------------------------- */
void cli_thread_main(char *install_dir_path, char **p4_names, bool local_only, uint16_t switchd_listen_port)
{
	...
	args->switchd_listen_port = switchd_listen_port;
